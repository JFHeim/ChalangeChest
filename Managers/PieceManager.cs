...
//                         {
//                             var inputItem = SerializedRequirements.fetchByName(objectDB, conversion.config.input.Value);
...
//                 {
//                     var requirements = SerializedRequirements.toPieceReqs(new SerializedRequirements(cfg.craft.Value));
//                     piecePrefab.m_resources = requirements;
//                     foreach (var instantiatedPiece in FindObjectsOfType<Piece>())
//                     {
//                         if (instantiatedPiece.m_name == pieceName)
...
//         }
//
//         var writers = peers.Where(peer => peer.IsReady()).Select(p => TellPeerAdminStatus(p, package)).ToList();
...
//                 }
//
//                 var hammerPieces = ObjectDB.instance.GetItemPrefab("Hammer").GetComponent<ItemDrop>().m_itemData
